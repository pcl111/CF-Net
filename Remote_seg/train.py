...
def train():
    ...
    dist.init_process_group(
                backend = 'nccl',
                init_method = 'tcp://127.0.0.1:35671',
    ...
    n_workers = 4
    cropsize = [256, 256]
    ds = CityScapes('/data/pcl/Remote_seg/dataset/Potsdam', cropsize=cropsize, mode='train')
...
#    LossP = NormalLoss(ignore_lb = ignore_idx)
    Loss2 = NormalLoss(ignore_lb = ignore_idx)
    ## optimizer
    momentum = 0.9
    weight_decay = 5e-4
    lr_start = 1e-2
